module.exports = function(client) {
  ...
  var builderMethods = ['wrap', 'from', 'into', 'table', 'column', 'columns', 'distinct',
    ...
    'having', 'havingRaw', 'orHaving', 'orHavingRaw', 'offset', 'limit', 'count', 'min', 'max', 'sum',
    'increment', 'decrement', 'select', 'pluck', 'insert', 'update', 'delete', 'del',
    'returning', 'option', 'truncate', 'transacting', 'forUpdate', 'forShare'];
  ...
  // var Transacting = BuilderInterface.extendChain([]);
