...
var SQLite3Client = module.exports = ServerBase.extend({
  ...
  constructor: function() {
    this.QueryBuilder = require('./sqlite3/query/builder')();
    this.QueryCompiler = require('./sqlite3/query/compiler')();
  },
  ...
  initSchema: function SQLite3$initSchema() {
    this.schemaBuilder = require('./sqlite3/schema/builder')();
    this.schemaTableCompiler = require('./sqlite3/schema/tablecompiler')();
