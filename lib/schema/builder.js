  ...
  _.extend(SchemaBuilder.prototype, Formatters, {
    ...
    toSql: function() {
      ...
      for (var i = 0, l = stack.length; i < l; i++) {
        ...
        sequence.push(this[method].apply(this, stack[i].args));
      }
      return sequence;
    },
    ...
    table: function(tableName, fn) {
      return new client.SchemaTableCompiler(new TableInterface(this, 'alter', tableName, fn));
    },

    // Create a new table on the schema.
    createTable: function(tableName, fn) {
      return new client.SchemaTableCompiler(new TableInterface(this, 'create', tableName, fn));
    },
